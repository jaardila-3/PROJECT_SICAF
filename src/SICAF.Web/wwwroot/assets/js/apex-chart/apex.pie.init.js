document.addEventListener("DOMContentLoaded", function () {
  ...
  const chartPieElement = document.querySelector("#chart-pie-simple");
  if (!chartPieElement) return;
  ...
  const chartDonutElement = document.querySelector("#chart-pie-donut");
  if (!chartDonutElement) return;
  ...
  const chartMonochromeElement = document.querySelector("#chart-pie-monochrome");
  if (!chartMonochromeElement) return;
